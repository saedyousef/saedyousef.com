...
function renderExperienceSection() {
    ...
    if (!container || !experiencesData.length)
        return;
    container.innerHTML = '';
...
function renderEducationSection() {
    ...
    if (!container || !educationData.length)
        return;
    container.innerHTML = '';
...
function renderGitHubActivities() {
...
function renderSkillCategories(container, skillsData) {
    container.innerHTML = '';
